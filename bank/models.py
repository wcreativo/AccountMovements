...
class Client(models.Model):
    ...
    type_identification = models.CharField(
        _("type identification"), max_length=2, choices=TYPE_IDENTIFICATIONS
    )
    ...
    current_date = models.DateTimeField(_("current date"), auto_now=True)
    ...
    class Meta:
        ...
        # Solution 1
        unique_together = (("number_identification", "type_identification"),)
...
class Account(models.Model):
    ...
    client = models.ForeignKey(
        Client, verbose_name=_("client"), on_delete=models.PROTECT
    )
    type = models.CharField(_("type"), max_length=1, choices=TYPES)
    number = models.CharField(_("number"), max_length=250, unique=True)
    ...
    class Meta:
        ...
        # Solution 3
        indexes = [models.Index(fields=["client"]), models.Index(fields=["number"])]
...
class Movements(models.Model):
    ...
    type = models.CharField(_("type"), max_length=10, choices=TYPES)
    account = models.ForeignKey(
        Account, verbose_name=_("account"), on_delete=models.PROTECT
    )
    value = models.DecimalField(_("value"), decimal_places=2, max_digits=15)
    current_date = models.DateTimeField(_("current date"), auto_now=True)
